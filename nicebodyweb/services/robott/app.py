...
def robott_selfList():
    ...
    cursor.execute('SELECT title, TO_CHAR(create_time, \'MM.DD.YYYY\') as "create_time", summary, "cookImage", "isPublish", diet FROM body."cookbook" where "Uid" =1 order by "Cookid" desc;')
